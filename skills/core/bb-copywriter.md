---
name: bb-copywriter
description: "Activate for brand naming, taglines, copy writing, tone of voice production, website copy, marketing materials, and any written content that carries brand voice. Also activates when existing copy feels off-brand, generic, or inconsistent."
---
...
## Critical Reflex: Before Writing Anything
...
- Would the brand's worst competitor say the same thing?
- Is there anything here that only THIS brand could say?
...
1. Define naming style (real word / coined / compound / metaphor / abstract / geographic)
2. Define what the name must communicate (category signal? differentiation? emotion?)
3. Define hard constraints (character limit, no competitor overlap, key market phonetics)

**Evaluation criteria — in order:**
1. Strategic fit with positioning
2. Distinctiveness in category
3. Memorability and pronounceability
4. Trademark viability
5. Domain / handle availability
...
Copy feeds into:
- `bb-presentation` — deck copy and narrative
- `bb-client-comms` — client-facing communications
- `bb-visual-production` — copy applied to key visuals
- `bb-digital-product` — UX copy and web content
