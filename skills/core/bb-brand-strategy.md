---
name: bb-brand-strategy
description: "Activate for positioning, naming, tone of voice, persona development, USP definition, and competitor analysis. Also activates when a brand feels generic, unclear, or undifferentiated — even if the client hasn't named the problem yet."
---
...
## Critical Reflex: Strategy Quality Check
...
### Positioning Territories — 3 Options Required
...
Not a feel-good statement. A genuine organizational belief that drives decisions.

**Values** — What principles are non-negotiable?
Max 4. If everything is a value, nothing is. Each value must be able to say "therefore we do X and we never do Y."

**Personality** — How does this brand behave?
Define as "is / is not" pairs:
- Confident / not arrogant
- Direct / not blunt
- Warm / not casual
- Expert / not academic

**Promise** — What can the audience count on, every time?
...
1. Define the naming territory (what feeling, what category signal)
2. Define the naming style (real word / invented / compound / metaphor / abstract)
3. Define the constraints (length, phonetics, trademark risk, domain availability)

Then generate — and evaluate against strategy, not personal preference.

**Evaluation criteria:**
- Distinctiveness in category
- Memorability
- Pronounceability across key markets
- Trademark viability
- Domain/handle availability
- Strategic fit with positioning
...
Strategy feeds into:
- `bb-brand-identity` — visual expression of the positioning
- `bb-copywriter` — TOV applied to real content
- `bb-presentation` — strategy document for client presentation
- `bb-client-comms` — if strategy needs to be sold to internal stakeholders
