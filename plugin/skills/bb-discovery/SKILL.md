---
name: bb-discovery
description: Activate when starting work with a new client, conducting a brand audit, benchmarking competitors, or answering 'where do we start' and 'what should we do'. Also activates when a brief feels incomplete or the real problem hasn't been named yet.
---
...
## Critical Reflex: Brief Quality Check
...
### 1. Business Context
- What does the business actually do? (not what they say — what they do)
- What stage is the business at? (early, scaling, pivoting, repositioning)
- What's the real commercial goal behind this project?
- What has been tried before and why did it fail?

### 2. Audience
- Who is the primary customer? Be specific — not "young professionals" but "fintech-savvy 28-35 year olds in Dubai who distrust traditional banks"
- What do they currently believe about this category?
- What needs to change in their mind?

### 3. Competitive Landscape
- Who are the real competitors? (not just obvious ones)
- What are they saying and doing?
- Where is the white space — the position no one owns?

### 4. Brand Audit (if existing brand)
- What's working? (don't break what works)
- What's broken?
- What's missing?
- What's the gap between how they see themselves and how the market sees them?
...
- `bb-brand-strategy` — positioning, TOV, USP
- `bb-brand-identity` — if visual direction emerges
- `bb-studio-ops` — if scope needs to be redefined based on findings
