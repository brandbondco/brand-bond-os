---
name: bb-presentation
description: Activate for presentation structure, proposal decks, pitch decks, and any document meant to persuade or inform a client or stakeholder. Also activates when a presentation exists but isn't landing — unclear, too long, or not compelling.
---

# bb-presentation

A presentation is a persuasion architecture. Every slide either builds the argument or dilutes it.
...
## Critical Reflex: Before Building Anything
...
- **Headline carries the argument** — not the topic, the claim
- **Visual supports the headline** — doesn't repeat it in graphic form
- **No bullet cemeteries** — if you have 6 bullets, you have 6 slides or a table
...
- `bb-copywriter` — deck copy and narrative language
- `bb-brand-identity` — presentation visual system
- `bb-client-comms` — how to introduce and frame the presentation
- `bb-studio-ops` — proposal decks with commercial content
