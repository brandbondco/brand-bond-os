---
name: bb-dp-spline
description: Activate for 3D web experiences, interactive 3D scenes, and Spline exports for web embedding. Use when evaluating whether 3D is appropriate for a web context.
---
