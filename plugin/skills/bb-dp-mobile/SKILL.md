---
name: bb-dp-mobile
description: Activate for iOS and Android UX decisions, native component usage, and mobile-specific interaction patterns. Use when a mobile design needs platform-appropriate choices.
---
